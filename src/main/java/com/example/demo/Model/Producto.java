...
public class Producto {
	...
	public Producto(int id, String nombre, Integer cantidad, String marca, String modelo, String voltaje, BigDecimal potencia, BigDecimal precio, Integer lumenes, String atenuable, String vidaUtil, String dimensiones, BigDecimal angulo, String descripcion, byte[] imagenes, String categoria) {
	        this.id = id;
	        this.nombre = nombre;
